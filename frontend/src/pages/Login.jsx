  ...
  return (
    <div className="max-w-sm mx-auto pt-12">
      ...
      <div className="space-y-3">
        <a
          href={GOOGLE_URL}
          className="flex items-center justify-center gap-3 w-full py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
        >
        ...
        <a
          href={NAVER_URL}
          className="flex items-center justify-center gap-3 w-full py-2.5 text-sm font-medium text-white bg-[#03C75A] rounded-lg hover:bg-[#02b351] transition-colors"
        >
